...
const RightSidebar = () => {
  return (
    <main className="bg-light-100 dark:bg-dark-300/70 right-sidebar-drop-shadow custom-scrollbar fixed right-0 h-screen w-full max-w-82.5 overflow-y-auto p-6 pt-16 max-lg:hidden max-lg:p-4 lg:max-w-[23%] xl:max-w-[22%] dark:border-0 dark:shadow-none">
